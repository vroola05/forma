...
public class StorageService {
    ...
    public String getBucketTemp() {
        return bucketTemp;
    }

    public String getBucketStored() {
        return bucketStored;
    }
    ...
    public boolean existsTempFile(String key) {
        return s3Template.objectExists(this.bucketTemp, key);
    }
    ...
    public boolean existsPublicAsset(String key) {
        return s3Template.objectExists(this.bucketPublic, key);
    }
    ...
    public boolean existsStoredFile(String key) {
        return s3Template.objectExists(this.bucketStored, key);
    }
