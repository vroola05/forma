...
@NoArgsConstructor
@AllArgsConstructor
public class DualListboxField implements Field {
    private UUID id;
    private String name;
    @Builder.Default
    ...
    public Field cloneField() {
        return new DualListboxField(id, name, labels, type, placeholder, classes, readonly, readonly, show, value, cloneOptions(values), metadata, cloneOptions(options), data, condition);
    }
