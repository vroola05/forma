...
public class DualListboxField implements Field {
    ...
    public Field cloneField() {
        return new DualListboxField(id, name, label, type, placeholder, classes, readonly, readonly, show, value, cloneOptions(values), metadata, cloneOptions(options), data, condition);
    }
