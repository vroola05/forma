import { BuilderFormGroup } from '../fields/builder-form-group.js';
import { BuilderField, BuilderFieldOptions } from '../fields/builder-field.js';
import { BuilderRepeatingGroup } from '../fields/builder-repeating-group.js';
...
export class Dropzone {
    ...
    addItem(type, label, droppedOnformItem) {
        ...
        EventService.getInstance().callEventListener('properties-changed', field);
        return field;
    }
