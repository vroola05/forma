...
export class AutocompleteField extends InputNucleus {
    ...
    createElement() {
        ...
        this.inputElement.addEventListener('input', (e) => {
            ...
            for (const c of this.onInputCallback) {
                c(value);
            }
    ...
    addOnInputListener(callback) {
        if (typeof callback !== 'function') {
            throw new Error('Callback must be a function');
        }
        this.onInputCallback.push(callback);
        return this;
    }

    clone() {
        const textfield = new AutocompleteField(this.name, this.label);
